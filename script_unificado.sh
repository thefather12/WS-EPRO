...
# Este script se auto-instala JQ y AWS CLI si no están presentes,
# y luego ejecuta el Panel de Administración de CloudFront.
# ==============================================================
...
# ----------------------------------------------------------------------
# FUNCIONES DE INSTALACIÓN Y CHEQUEO DE REQUISITOS (DEL SCRIPT 1)
# ----------------------------------------------------------------------
...
export_aws_path() {
    if [[ ":$PATH:" != *":$AWS_BIN_PATH:"* ]]; then
        ...
        AWS_CLI=$(which aws 2>/dev/null) # Re-evaluar
    fi
}
...
# ----------------------------------------------------------------------
# FUNCIONES DE CLOUDFRONT (DEL SCRIPT 2)
# ----------------------------------------------------------------------
